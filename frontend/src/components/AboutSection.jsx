        ...
        <div className="dark-content-container">
          ...
          <div style={{ marginTop: '60px', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{
              ...
              {/* Creative Strategy vs Narrative Showcase */}
              <div style={{ marginBottom: '60px', maxWidth: '1000px', margin: '0 auto 60px auto' }}>
                
                {/* Opening Statement - Large Impact Typography */}
                <div style={{
                  textAlign: 'center',
                  marginBottom: '50px',
                  position: 'relative'
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'center' }}>
                    ...
                    onMouseOver={(e) => {
                      ...
                      e.currentTarget.style.border = '2px solid rgba(0, 255, 209, 0.3)';
                    }}
                    onMouseOut={(e) => {
                  ...
                  <div style={{
                    ...
                    <div style={{
                      width: '60px',
                      height: '2px',
                      background: 'linear-gradient(90deg, var(--text-secondary) 0%, var(--brand-primary) 100%)',
                      position: 'relative',
                      borderRadius: '2px'
                    }}>
                      <div style={{
                        ...
                        width: '0',
                        height: '0',
                        borderLeft: '8px solid var(--brand-primary)',
                  ...
                  <div style={{ textAlign: 'center' }}>
                    ...
                    onMouseOver={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = '0 0 30px rgba(0, 255, 209, 0.4)';
                    }}
                    onMouseOut={(e) => {
                ...
                <div style={{
                  ...
                  marginTop: '40px',
                  padding: '30px',
                  background: 'linear-gradient(135deg, rgba(0, 255, 209, 0.05) 0%, rgba(0, 255, 209, 0.02) 100%)',
                  borderRadius: '12px',
                  border: '1px solid rgba(0, 255, 209, 0.1)'
                }}>
                  <p style={{
                    ...
                    "When people can <span style={{ color: 'var(--brand-primary)', fontWeight: '500' }}>see, feel, and believe</span> your vision,{' '}
                    <span style={{ color: 'var(--brand-primary)', fontWeight: '500' }}>it shifts how they think and act today</span>."
                  </p>
                </div>
