      ...
      <div className="dark-full-container">
        <div className="dark-content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "50px" }}>
            ...
            >
              We design the next generation of products, partnerships, and
              markets – beyond industry borders.
            </p>
                ...
                <div
                  ...
                  onMouseOver={(e) => {
                    ...
                    e.currentTarget.style.boxShadow =
                      "0 20px 40px rgba(0, 255, 209, 0.2)";
                  }}
                  onMouseOut={(e) => {
          ...
          >
            ...
            >
              ...
              <div
                className="floating-element spreadsheet-1"
                style={{
                  position: "absolute",
                  top: "15%",
                  left: "10%",
              ...
              <div
                className="floating-element spreadsheet-2"
                style={{
                  position: "absolute",
                  top: "25%",
                  right: "15%",
              ...
              <div
                className="floating-element spreadsheet-3"
                style={{
                  position: "absolute",
                  bottom: "30%",
                  left: "20%",
              ...
              <div
                className="floating-element story-1"
                style={{
                  position: "absolute",
                  top: "20%",
                  right: "20%",
              ...
              <div
                className="floating-element story-2"
                style={{
                  position: "absolute",
                  bottom: "40%",
                  right: "10%",
