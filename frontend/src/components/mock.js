...
export const mockMagazines = [
  {
    ...
    year: "2040",
    description:
      "How your company's AI-driven manufacturing revolution reshaped global supply chains",
    coverImage:
      "https://customer-assets.emergentagent.com/job_crossindustry-hub/artifacts/shrinfn0_9699c082-7b0a-408d-9849-2648ee928919.webp",
    industries: ["Manufacturing", "AI", "Supply Chain"],
    preview:
      "In this timeline, your breakthrough in quantum-enhanced AI transformed manufacturing from reactive to predictive, creating $2.3B in new revenue streams...",
  },
  {
    id: 2,
    ...
    year: "2035",
    description:
      "Your chocolate-based personalized medicine platform revolutionizes healthcare delivery",
    coverImage:
      "https://customer-assets.emergentagent.com/job_crossindustry-hub/artifacts/mjch8sxn_ca4f8bf6-4ee0-44ee-940e-0d401645c0e2.png",
    industries: ["Healthcare", "Food Tech", "Personalized Medicine"],
    preview:
      "By 2035, your molecular gastronomy breakthrough enabled precise drug delivery through everyday foods, reaching 50M patients globally...",
  },
  {
    id: 3,
    ...
    year: "2038",
    description:
      "Self-healing infrastructure materials from your company now rebuilding cities worldwide",
    coverImage:
      "https://customer-assets.emergentagent.com/job_future-vision-6/artifacts/v4ds5j7a_7cabefac-c0dc-4c06-8ba9-893b718bc34e.webp",
    industries: ["Materials Science", "Urban Planning", "Infrastructure"],
    preview:
      "Your self-healing concrete technology became the foundation for resilient cities, preventing $500B in infrastructure maintenance costs...",
  },
];
...
export const mockTeamMembers = [
  {
    ...
    photo_url:
      "https://customer-assets.emergentagent.com/job_future-landing-4/artifacts/5o6z0uxx_WhatsApp%20Image%202025-10-09%20at%2018.44.38.jpeg",
  ...
  },
  {
    ...
    photo_url:
      "https://customer-assets.emergentagent.com/job_future-landing-4/artifacts/6mottjaq_Katyaa.jfif",
    linkedin: "https://www.linkedin.com/in/katerina-de-pauw-8178436/",
    description:
      "As Business Development Director, Katerina brings the magazine's imagination into the world of business — shaping dialogues, opening partnerships, and translating futures thinking into commercial reality. Her cross-domain path embodies the polymathic spirit: moving between education, trade, and well-being, she connects vision with value and ensures innovation finds its audience.",
  },
];
...
export const mockServices = [
  {
    ...
    description:
      "We craft literal magazines from the future — from 2035, 2040, even 2060 — written as if your company's breakthroughs have already happened.",
    features: [
  ...
  },
  {
    ...
    description:
      "In a private session with our leading scientific futurists, you'll receive research-backed yet deeply imaginative insights into the future of your industry.",
    features: [
    ...
    timeframe: "2-4 hours",
    ideal_for:
      "Leaders seeking personalized strategic foresight and breakthrough opportunities",
  },
  {
    id: 3,
    title: "Sci-Fi Prototyping Workshops",
    description:
      "Interactive sessions where your team designs products that don't exist yet",
    features: [
      "Design fiction methodologies",
      "Team innovation exercises",
...
export const consultationTypes = [
  {
    id: 1,
    type: "Future Magazine Creation",
    duration: "8-12 weeks",
    description: "Craft a literal magazine from your company's future",
  },
  {
    id: 2,
    type: "Futurist Mastermind",
    duration: "2-4 hours",
    description: "One-to-one deep dive with scientific futurists",
  },
  {
    id: 3,
    type: "Sci-Fi Prototyping Workshop",
    duration: "2-3 days",
    description:
      "Interactive team session designing products that don't exist yet",
  },
];
